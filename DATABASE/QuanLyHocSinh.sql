...
(
	MaNguoiDung NVARCHAR(6) NOT NULL PRIMARY KEY,
...
CREATE TABLE DANTOC
(
	MaDanToc NVARCHAR(6) NOT NULL PRIMARY KEY,
...
(
	MaTonGiao NVARCHAR(6) NOT NULL PRIMARY KEY,
...
CREATE TABLE NAMHOC
(
	MaNamHoc NVARCHAR(6) NOT NULL PRIMARY KEY,
...
CREATE TABLE HOCKY
(
	MaHocKy NVARCHAR(3) NOT NULL PRIMARY KEY,
...
(
	MaKhoiLop NVARCHAR(6) NOT NULL PRIMARY KEY,
...
CREATE TABLE MONHOC
(
	MaMonHoc NVARCHAR(6) NOT NULL PRIMARY KEY,
...
CREATE TABLE HOCLUC
(
	MaHocLuc NVARCHAR(6) NOT NULL PRIMARY KEY,
...
(
	MaHanhKiem NVARCHAR(6) NOT NULL PRIMARY KEY,
...
CREATE TABLE KETQUA
(
	MaKetQua NVARCHAR(6) NOT NULL PRIMARY KEY,
...
(
	MaNghe NVARCHAR(6) NOT NULL PRIMARY KEY,
...
(
	MaGiaoVien NVARCHAR(6) NOT NULL PRIMARY KEY,
...
(
	MaHocSinh NVARCHAR(6) NOT NULL PRIMARY KEY,
	HoTen NVARCHAR(30) NOT NULL,
	GioiTinh BIT,
	NgaySinh DATETIME,
	DiaChi NVARCHAR(50) NOT NULL,
	MaDanToc NVARCHAR(6) NOT NULL,
	MaTonGiao NVARCHAR(6) NOT NULL,
	HoTenCha NVARCHAR(30) NOT NULL,
	MaNNghiepCha NVARCHAR(6) NOT NULL,
	HoTenMe NVARCHAR(30) NOT NULL,
	MaNNghiepMe NVARCHAR(6) NOT NULL,
...
(
	...
	MaKhoiLop NVARCHAR(6) NOT NULL,
	MaNamHoc NVARCHAR(6) NOT NULL,
	SiSo INT NOT NULL,
	MaGiaoVien NVARCHAR(6) NOT NULL,
